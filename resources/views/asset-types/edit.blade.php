            ...
            <form action="{{ route('asset-types.update', $assetType) }}" method="POST" class="p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <select id="asset_category" name="asset_category"
                            ...
                            required>
                            <option value="general_asset" {{ old('asset_category', $assetType->asset_category) == 'general_asset' ? 'selected' : '' }}>General Asset</option>
                            <option value="parking_asset" {{ old('asset_category', $assetType->asset_category) == 'parking_asset' ? 'selected' : '' }}>Parking Asset</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="geometry" name="geometry"
                            ...
                            required>
                            <option value="point" {{ old('geometry', $assetType->geometry) == 'point' ? 'selected' : '' }}>Point (Titik)</option>
                            <option value="polygon" {{ old('geometry', $assetType->geometry) == 'polygon' ? 'selected' : '' }}>Polygon (Area)</option>
                            <option value="polyline" {{ old('geometry', $assetType->geometry) == 'polyline' ? 'selected' : '' }}>Polyline (Garis)</option>
                        </select>
                        @error('geometry')
                            <p class="text-red-500 text-sm mt-2 flex items-center gap-1">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="mb-8">
                    <label class="flex items-center gap-3">
                        <input type="checkbox" name="is_active" id="is_active" class="w-5 h-5 text-blue-600 border-2 border-gray-300 rounded focus:ring-blue-500" {{ old('is_active', $assetType->is_active) ? 'checked' : '' }}>
