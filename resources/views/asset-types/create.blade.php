        ...
        <form action="{{ route('asset-types.store') }}" method="POST" class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div>
                    ...
                    <!-- Icon Preview -->
                    <div id="iconPreview" class="mb-4 p-4 bg-blue-50 rounded-lg text-center border-2 border-blue-200 hidden">
                ...
                <div>
                    <label for="color" class="block text-sm font-bold text-gray-700 mb-3">
                        <i class="fas fa-palette text-blue-600 mr-2"></i> Warna Kategori <span class="text-red-500">*</span>
                    </label>
                    ...
                    <div id="colorPreview" class="mb-4 p-4 bg-gray-50 rounded-lg border-2 border-gray-200">
                        ...
                        <div class="flex items-center gap-4">
                            <div id="colorCircle" class="w-16 h-16 rounded-lg border-4 border-gray-300 transition" style="background-color: #3B82F6;"></div>
                            <div>
                    ...
                    <div class="flex gap-3">
                        <div class="flex-1">
                            ...
                            <input type="color" id="colorPicker" 
                                ...
                                value="#3B82F6" onchange="updateColorPreview()">
                        </div>
                        <div class="flex-1">
                            ...
                            <input type="text" id="colorHex" name="color"
                                ...
                                value="{{ old('color', '#3B82F6') }}" placeholder="#000000" required onchange="updateColorFromHex()">
                        </div>
                    </div>
            ...
            <div class="mb-8 p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border-2 border-gray-200">
                ...
                <div class="flex items-center gap-6">
                    <div id="previewCard" class="flex items-center gap-4 p-4 bg-white rounded-lg flex-1">
                        <div id="previewIconContainer" class="w-16 h-16 rounded-lg flex items-center justify-center text-3xl" style="background-color: #3B82F620; color: #3B82F6;">
