...
@section('title', 'Tambah Usulan Lama - SIPETA-TRANS')
@section('page-title', 'Tambah Usulan Lama')
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-6 rounded-t-lg relative">
                ...
                <h2 class="text-3xl font-bold">Formulir Input Usulan Lama</h2>
                <p class="text-blue-100 mt-2">Lengkapi data riwayat usulan masyarakat untuk masuk ke sistem.</p>
            </div>

            <!-- Form -->
            <form method="POST" action="{{ route('proposals.store') }}" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="mb-8 pb-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="pengusul" value="{{ old('pengusul') }}" placeholder="Instansi / perorangan" required 
                        ...
                        <div>
                            ...
                            <input type="email" name="email_pengusul" value="{{ old('email_pengusul') }}" placeholder="Alamat email" required 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8 pb-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select id="asset_type_id" name="asset_type_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required onchange="updateSubtypes()">
                                ...
                                @foreach ($assetTypes as $type)
                                    <option value="{{ $type->name }}" data-subtypes='@json($type->subtypes)' @selected(old('asset_type_id') === $type->name)>
                                        {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div style="display: none;" id="subtype-wrapper">
                            ...
                            <select id="asset_sub_type_id" name="asset_sub_type_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" onchange="updateJenisPermintaan()" data-old="{{ old('asset_sub_type_id') }}">
                                <option value="">-- Pilih Sub Jenis Aset --</option>
                            </select>
                        </div>
                        <input type="hidden" id="jenis_permintaan" name="jenis_permintaan" value="{{ old('jenis_permintaan') }}">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="perkiraan_anggaran" value="{{ old('perkiraan_anggaran') }}" 
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="lokasi" id="location" value="{{ old('lokasi') }}" placeholder="Nama jalan / area / titik lokasi..." required 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="latlng_wrapper">
                        <div>
                            ...
                            <input type="number" id="latitude" name="latitude" value="{{ old('latitude', -0.305218) }}"
                        ...
                        <div>
                            ...
                            <input type="number" id="longitude" name="longitude"
                                value="{{ old('longitude', 100.369574) }}" step="0.000001" placeholder="100.369574"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <p class="text-xs text-gray-500 mt-1">Default: Bukittinggi</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="kelayakan" id="kelayakan" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="layak" @selected(old('kelayakan') === 'layak')>✅ Layak</option>
                                <option value="tidak layak" @selected(old('kelayakan') === 'tidak layak')>❌ Tidak Layak</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <select name="status" id="status" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="ditindak lanjuti" @selected(old('status') === 'ditindak lanjuti')>Ditindak lanjuti</option>
                ...
                <div class="mb-8 pb-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                Arsip Surat (PDF) <span class="text-red-500">*</span>
                            </label>
                            <input type="file" name="arsip_surat" accept=".pdf" required 
                ...
                <div class="flex gap-4 justify-end">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save"></i> Simpan Data Usulan
                    </button>
                </div>
            </form>
        </div>
