...
<head>
    ...
    <title>Daftar — SIPETA-TRANS</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center font-[Instrument_Sans] antialiased">
    ...
    <div class="w-full max-w-3xl mx-4 rounded-2xl overflow-hidden shadow-2xl flex min-h-[540px]">
        ...
        <div class="flex-1 bg-white flex flex-col justify-center px-8 py-10 md:px-10">
            ...
            <p class="text-gray-500 text-sm mb-7">Isi data di bawah untuk mendaftarkan akun Anda</p>
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        autofocus
                        required
                        class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition placeholder-gray-400 @error('name') border-red-400 bg-red-50 @enderror"
                    />
                    @error('name')
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                                class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition placeholder-gray-400 pr-9 @error('password') border-red-400 bg-red-50 @enderror"
                            />
                            <button type="button" onclick="togglePwd('password','icon1')" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <i class="fas fa-eye text-xs" id="icon1"></i>
                            </button>
                        </div>
                        @error('password')
                            <p class="text-xs text-red-600">{{ $message }}</p>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input
                                ...
                                autocomplete="new-password"
                                required
                                class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition placeholder-gray-400 pr-9"
                            />
                            <button type="button" onclick="togglePwd('password_confirmation','icon2')" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <i class="fas fa-eye text-xs" id="icon2"></i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <p class="text-center text-xs text-gray-400 mt-8">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-blue-700 hover:text-blue-800 font-medium">Masuk di sini</a>
            </p>
        </div>
    </div>
