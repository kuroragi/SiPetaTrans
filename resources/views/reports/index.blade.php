            ...
            <form action="{{ route('reports.print') }}" method="POST" target="_blank" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="type" id="report_type"
                        ...
                        <option value="proposal">Daftar Usulan Masyarakat</option>
                    </select>
                </div>

                <!-- Asset Filters (Hidden by default) -->
                <div id="asset_filters"
                    class="hidden space-y-4 border-l-4 border-blue-500 pl-4 py-2 mt-4 bg-gray-50 rounded-r-lg">
                    <div>
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full px-4 py-2.5 text-white font-medium rounded-lg transition-all duration-200 hover:bg-blue-700 bg-blue-600 shadow hover:shadow-md border-none cursor-pointer mt-4">
