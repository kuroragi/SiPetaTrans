    ...
    <div class="col-span-2 bg-white rounded-lg shadow p-6">
        <div class="mb-4">
            ...
            <div class="flex gap-2 flex-wrap">
                <button class="px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-700 hover:bg-blue-200 cursor-pointer filter-btn active" data-filter="all">
                    ✓ Semua Aset
                </button>
                <button class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 cursor-pointer filter-btn" data-filter="type" data-type-id="0">
                    Transportasi
                </button>
                <button class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 cursor-pointer filter-btn" data-filter="status" data-status="baik">
                    Kondisi Baik
                </button>
                <button class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 cursor-pointer filter-btn" data-filter="status" data-status="rusak">
                    Rusak
                </button>
            </div>
        </div>
...
<script>
    ...
    const map = L.map('map').setView([-6.2088, 106.8456], 14);
    ...
    legend.onAdd = function(map) {
        ...
        const legendTitle = '<div style="font-weight: bold; margin-bottom: 8px; font-size: 13px; border-bottom: 2px solid #3b82f6; padding-bottom: 6px;">Kondisi Aset</div>';
