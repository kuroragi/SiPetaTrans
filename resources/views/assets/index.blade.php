...
<div class="mb-6 flex justify-between items-center">
    <div class="flex gap-4 flex-1">
        <input type="text" placeholder="Cari aset..." class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    <a href="{{ route('assets.create') }}" class="ml-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition flex items-center gap-2">
